...
build-go: ## Build the Go API
	@cd api && go build -buildvcs=false -ldflags "-X github.com/ksuk/merlon/api/internal/buildinfo.Version=$(VERSION)" ./cmd/merlon-api
...
generate-openapi: ## Export the OpenAPI spec to docs/api/openapi.json
	@cd api && go run -ldflags "-X github.com/ksuk/merlon/api/internal/buildinfo.Version=$(VERSION)" ./cmd/openapi-export -o ../docs/api/openapi.json
