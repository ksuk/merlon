...
- *ドキュメント負債*：アーキテクチャドキュメント、アダプタガイドの gRPC 記述、公開済みの gRPC プロトコルリファレンス、各コンポーネントの AGENTS.md、compose ファイル、および PH7 のデモ構成（現状 Engine コンテナを指定している）を、すべて同じ作業の中で更新しなければならない。
