...
export function CoverageAnalysesPage() {
  ...
  async function queueAnalysis() {
    try {
      ...
      const created = await api.coverageAnalyses.create({ from: from.toISOString(), to: to.toISOString(), rule_set_id: "active" })
