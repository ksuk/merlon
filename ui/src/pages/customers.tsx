...
export function CustomersPage() {
  ...
  const { data: page, loading, error } = useApi(() => api.customers.listAll({ search: filter }), `${filter}|${refreshKey}`)
  ...
  async function handleCreate(event: React.FormEvent) {
    ...
    try {
      ...
      // A full page reload discarded every other piece of state on the
      // screen, including the search the operator had just typed.
